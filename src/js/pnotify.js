...
const invalidMessage =
  "Sorry we couldn’t find anything =/. Change your request, please!";
const errorMessage =
  "Sorry, but we can’t get an answer now. Please try again later.";
const noMoreMessage =
  "Sorry, we haven’t found anything else. You can send a new request!";
